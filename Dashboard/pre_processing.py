...
pca_1 = joblib.load('Dashboard/model/pca_1.joblib')
pca_2 = joblib.load('Dashboard/model/pca_2.joblib')

encoder_Tuition_fees_up_to_date = joblib.load('Dashboard/model/encoder_Tuition_fees_up_to_date.joblib')
encoder_Course = joblib.load('Dashboard/model/encoder_Course.joblib')
encoder_Scholarship_holder = joblib.load('Dashboard/model/encoder_Scholarship_holder.joblib')
encoder_Gender = joblib.load('Dashboard/model/encoder_Gender.joblib')
encoder_Displaced = joblib.load('Dashboard/model/encoder_Displaced.joblib')
encoder_Application_mode = joblib.load('Dashboard/model/encoder_Application_mode.joblib')
encoder_Previous_qualification = joblib.load('Dashboard/model/encoder_Previous_qualification.joblib')
encoder_Debtor = joblib.load('Dashboard/model/encoder_Debtor.joblib')
encoder_Marital_status = joblib.load('Dashboard/model/encoder_Marital_status.joblib')
encoder_Daytime_evening_attendance = joblib.load('Dashboard/model/encoder_Daytime_evening_attendance.joblib')

scaler_Admission_grade = joblib.load('Dashboard/model/scaler_Admission_grade.joblib')
scaler_Age_at_enrollment = joblib.load('Dashboard/model/scaler_Age_at_enrollment.joblib')
scaler_Curricular_units_1st_sem_approved = joblib.load('Dashboard/model/scaler_Curricular_units_1st_sem_approved.joblib')
scaler_Curricular_units_1st_sem_enrolled = joblib.load('Dashboard/model/scaler_Curricular_units_1st_sem_enrolled.joblib') 
scaler_Curricular_units_1st_sem_evaluations = joblib.load('Dashboard/model/scaler_Curricular_units_1st_sem_evaluations.joblib')
scaler_Curricular_units_1st_sem_grade = joblib.load('Dashboard/model/scaler_Curricular_units_1st_sem_grade.joblib')
scaler_Curricular_units_2nd_sem_approved = joblib.load('Dashboard/model/scaler_Curricular_units_2nd_sem_approved.joblib')
scaler_Curricular_units_2nd_sem_enrolled = joblib.load('Dashboard/model/scaler_Curricular_units_2nd_sem_enrolled.joblib')
scaler_Curricular_units_2nd_sem_evaluations = joblib.load('Dashboard/model/scaler_Curricular_units_2nd_sem_evaluations.joblib')
scaler_Curricular_units_2nd_sem_grade = joblib.load('Dashboard/model/scaler_Curricular_units_2nd_sem_grade.joblib')
scaler_Previous_qualification_grade = joblib.load('Dashboard/model/scaler_Previous_qualification_grade.joblib')
